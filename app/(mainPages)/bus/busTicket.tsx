...
import BusTicketDetails from './busDetails'
interface IBusTicket{
      type:"train"|"metro",
     number:number,
     from:{
        station:string
...
const BusTicket = ({number,from,to,count,price,round,type,ticket}:IBusTicket) => {
  return (
          ...
          <Accordion type="single" collapsible className='w-full' >
              <AccordionItem value='1' >
                    ...
                    <AccordionContent className='w-full' >
                          <BusTicketDetails  count={count} price={price} ticket={ticket}/>
                    </AccordionContent>
